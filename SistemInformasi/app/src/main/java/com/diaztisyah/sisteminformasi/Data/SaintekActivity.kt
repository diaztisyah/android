...
class SaintekActivity : AppCompatActivity() {
    ...
    fun getListMyDatas(): ArrayList<MyData> {
        val dataName = resources.getStringArray(R.array.listsaintek)
        val dataPhoto = resources.getStringArray(R.array.saintek)
        val dataDes = resources.getStringArray(R.array.karakter)
